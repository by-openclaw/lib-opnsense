...
| dnsmasq sub-resources (option, boot, tag) | — | `dnsmasq/settings/{search,add,set,del,toggle}*` | `PENDING` | Tracked under epic [#65](https://github.com/by-openclaw/lib-opnsense/issues/65) — Phase 7 |
