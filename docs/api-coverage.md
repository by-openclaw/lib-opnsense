...
| dnsmasq sub-resources (domain, option, boot, tag) | — | `dnsmasq/settings/{search,add,set,del,toggle}*` | `PENDING` | Tracked under epic [#65](https://github.com/by-openclaw/lib-opnsense/issues/65) — Phases 6–7 |
