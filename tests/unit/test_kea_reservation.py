"""Unit tests for opnsense.managers.kea_reservation.KeaReservationManager."""
...
class TestEnsurePresent:
    async def test_create(self, mock_client: AsyncMock) -> None:
        ...
        mgr = KeaReservationManager(mock_client)
...
class TestEnsureAbsent:
    async def test_delete(self, mock_client: AsyncMock) -> None:
        ...
        mock_client.get.return_value = {"reservation": {"uuid": "uuid-1", "hostname": "test-host"}}
