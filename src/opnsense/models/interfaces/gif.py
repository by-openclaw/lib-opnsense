...
"""OPNsense interface GIF tunnel model — typed frozen dataclass.

Maps to OPNsense API: ``/api/interfaces/gif_settings``
Payload key: ``gif``
...
class IfGif:
    """GIF tunnel interface entity from OPNsense interfaces/gif_settings API.
